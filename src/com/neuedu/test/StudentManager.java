...
//               退出
    ...
    public void add(){
        Student student=new Student(1,2642,"李",147,"20","女",
                160,50,"1999-03-15",1);
        JdbcPer.executUpate("insert into student(id,sno,sname,spaw,sage,sheight,sweight,sbirthday,ssex,sflag)" +
                        " values (?,?,?,?,?,?,?,?,?,?)",
                student.getId(),student.getSno(),student.getSname(),student.getSpaw(),student.getSage(),
                student.getSsex(),student.getSheight(),student.getSweight(),
                student.getSbirthday(),student.getSflag());
    }
    public void delete() {
        Student student=new Student();
          JdbcPer.executUpate("delete from student where id=?",3);
    }
    public void  update(){
        Student student=new Student();
